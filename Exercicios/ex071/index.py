...
for numero in range(0, 21):
    numero = int(input(f"{estilos['negrito']}{cores['azul']}Digite um número entre {cores['limpa']}{cores['vermelho']}{estilos['negrito']}0 e 20:{cores['limpa']} "))
    print(f"o número digitado foi {estilos['negrito']}{cores['verde']}{extenso[numero]}{estilos['reset']}")
    if numero < 0 or numero > 20:
        print(f"{estilos['negrito']}{cores['vermelho']}Número inválido!{estilos['reset']}")